    ...
    <diV class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col-md-10 p-5 pt-2 ">
                ...
                <a href="input_customer.php" class="btn btn-primary mb-3"><i class="fa-regular fa-square-plus" style="margin-right:5px;"></i>Tambah Data Customer</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?=$data['customer_alamat'];?></td>
                                <td><?=$data['customer_tlp'];?></td>
                                <td><?=$data['customer_datareg'];?></td>
                                
                                <td>
                                    <a href="update_customer.php?customer_id=<?=$data['customer_id'];?>" value="ubah" class="btn btn-warning">
                                        <i class="fa-regular fa-pen-to-square" data-bs-toggle="tooltip" title="Edit"></i>
                                    </a> - 
                                    <a href="customer.php?customer_id=<?=$data['customer_id'];?>" value="ubah" class="btn btn-danger">
