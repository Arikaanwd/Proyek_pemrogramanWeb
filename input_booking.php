            ...
            <div class="col-md-10 p-5 pt-2 ">
                ...
                <div class="col-6">
                    ...
                    if(isset($_POST['simpan'])){
                        ...
                        $query_simpan = "INSERT INTO book SET book_id='$book_id', customer_id='$customer_id', room_id='$room_id',
                        book_date='$book_date', book_desc='$book_desc'";
                    ...
                    <form action="" method="post">
                        ...
                        <select name="room_id" class="form-control">
                            ...
                            echo "<option value='".$d_room['room_id']."'>".$d_room['room_id']."</option>";
                            }
                        ?>
                        </select>
                        <br>
